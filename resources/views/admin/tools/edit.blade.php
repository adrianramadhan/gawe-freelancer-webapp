            ...
            <div class="bg-gray-800 overflow-hidden p-10 shadow-lg sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.tools.update', $tool) }}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full bg-gray-700 text-gray-200 border-gray-600 focus:border-indigo-500 focus:ring-indigo-500" type="text" name="name" value="{{ $tool->name }}" required autofocus autocomplete="name" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="icon" class="block mt-1 w-full bg-gray-700 text-gray-200 border-gray-600 focus:border-indigo-500 focus:ring-indigo-500" type="file" name="icon" autofocus autocomplete="icon" />
