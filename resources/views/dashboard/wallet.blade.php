    ...
    <div class="py-12 bg-gray-900 min-h-screen">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <h3 class="text-gray-200 text-xl font-bold">Latest Transactions</h3>
                ...
                @forelse ($wallet_transaction as $transaction)
                    <div class="flex flex-row justify-between items-center">
                        ...
                        <div>
                            ...
                            <h3 class="text-gray-200 text-xl font-bold">{{ $transaction->type }}</h3>
                        </div>
                        ...
                        <div>
                            ...
                            <h3 class="text-gray-200 text-xl font-bold">{{ $transaction->created_at->format('M d, Y') }}
                            </h3>
                        </div>
                    </div>
                @empty
