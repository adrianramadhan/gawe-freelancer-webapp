...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('can:withdraw wallet')->group(function () {
        ...
        Route::post('/dashboard/wallet/withdraw', [DashboardController::class, 'withdraw_wallet_store'])
    ...
    Route::prefix('admin')->name('admin.')->group(function(){
        ...
        Route::middleware('can:manage wallets')->group(function () {
            ...
            Route::get('/wallet/withdrawals', [WalletTransactionController::class, 'wallets_withdrawals'])
            ->name('withdrawals');
